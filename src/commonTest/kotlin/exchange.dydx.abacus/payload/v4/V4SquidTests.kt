...
class V4SquidTests : V4BaseTests() {
    ...
    fun testSelectedTokenSymbol() {
        ...
        assertTrue(perp.routingProcessor.selectedTokenSymbol("0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE") == "ETH")
    }
    ...
    fun testSelectedTokenDecimals() {
        ...
        assertTrue(perp.routingProcessor.selectedTokenDecimals("0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE") == "18")
    }
    ...
    fun testDefaultTokenAddress() {
        ...
        assertTrue(perp.routingProcessor.defaultTokenAddress("1") == "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE")
    }
    ...
    fun testChainResources() {
        ...
        val result = parser.asMap(perp.routingProcessor.chainResources("1"))!!
